    	...
    	<div class="top">
            ...
            <div class="top_menu">
            	<ul>
                    ...
                    <li><a href="mood!adminmoodlist" style="background-color:#226411;">心情管理</a></li>
        ...
        <div class="content" style="overflow-y:auto; overflow-x:auto; height:480px;"><%--style="overflow:scroll;" --%>
        	<div class="user_info_title">
                ...
                <table border="1" cellspacing="0" bordercolor="#D1DDAA" width = "80%" style="border-collapse:collapse;"  >
                	<tr bgcolor="#ffffff"><td>选择</td><td>用户名</td><td>心情编号</td><td>心情内容</td><td>心情发送时间</td><td>点赞人数</td><td>修改</td><td>删除</td></tr>
                    <c:forEach items="${requestScope.list }" var="vo">
                    <tr style="font-size: 13px;"><td><input type="checkbox"/></td><td>${vo.u_name }</td><td>${vo.m_id }</td><td>${vo.m_content}</td><td>${vo.m_totime }</td><td>${vo.m_agreecount }</td><td><a href="usersinfoupdate?uname=${vo.u_name }">修改</a></td><td><a href="usersinfodelete?uname=${vo.u_name}" onclick="return window.confirm('您确定要删除吗？')">删除</a></td></tr>
                    </c:forEach>
