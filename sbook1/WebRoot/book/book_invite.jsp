...
<div class="header2">
  ...
  <div class="content">
	...
	<div class="log_top">
        ...
        <p><b>[${sessionScope.UserName }]的同学录-邀请好友填写同学录</b></p><hr/>
    ...
    <div class="log_botton">
    	<div class="log_menu">
        	<ul>
                ...
                <li style="background-color:white; border-left:1px solid green; border-right:1px solid green; border-top:1px solid green;"><a href="sbook!bookgoinvite" style="color:black;">邀请好友填写</a></li>
            </ul>
        </div>
        <hr color="#8CDA5C"/>
        <div class="log_botton_freindslog">
            ...
            <div class="log_botton_mylog_yes">
            	<div class="invit_border">
            	<form action="mail!mailgowrite" method="post">
           	    <table>
                    	<tr><td width="108" height="54">&nbsp;&nbsp;<span style="color:#808080;">选择好友：</span></td><td width="580">
                    	<select name="fname" style="color:#808080;width:110px;" id="book_style">
                            	<c:forEach items="${requestScope.list }" var="vo">
                            	<option value="${vo.fName }">${vo.fName }</option>
                            	</c:forEach>
                    </select></td></tr>
                    <tr><td height="38">&nbsp;&nbsp;<input type="submit" value="邮件发送" style="color: gray;"/></td><td><input type="button" value="悄悄话发送" style="color: gray;"/></td></tr>
                  </table>
                  </form>
                </div>
            </div>
