...
<div class="header2">
  ...
  <div class="content">
	...
	<div class="log_top">
        ...
        <p><b>[${sessionScope.UserName }]的同学录-${requestScope.fname }的同学录</b></p><hr/>
    ...
    <div class="log_botton">
        ...
        <div class="log_botton_freindslog">
            ...
            <div class="log_botton_mylog_yes">
				<div class="book_write_content" id="book_write_content">
                	<div style="float:right; margin-right:10px;"><span style="cursor:pointer;color: green;" onclick="changestyle('0')">默认皮肤</span> &nbsp;<span style="cursor:pointer;color: green;" onclick="changestyle('1')">皮肤一</span> &nbsp;</div>
                	<table align="center">
    	<tr><td width="120" height="64">你的大名：</td><td width="217"><input type="text" readonly="readonly" value="${requestScope.vo.uBigname }"/></td><td width="154">你的昵称：</td><td width="189"><input type="text" readonly="readonly" value="${requestScope.vo.bNickname }"/></td></tr>
        <tr><td height="51">破蛋日期：</td><td><input type="text" readonly="readonly" value="${requestScope.vo.bBirth }"/></td><td>QQ　号：</td><td><input type="text" readonly="readonly" value="${requestScope.vo.bQq }"/></td></tr>
        <tr><td height="57">电话号码：</td><td><input type="text" readonly="readonly" value="${requestScope.vo.bTelphone1 }"/></td><td>手机号码：</td><td><input type="text" readonly="readonly" value="${requestScope.vo.bTelphone2 }"/></td></tr>
        <tr><td height="56">家庭住址：</td><td><input type="text" value="${requestScope.vo.bAddress }"/></td><td>爱　好：</td><td><input type="text" readonly="readonly" value="${requestScope.vo.bHobby }"/></td></tr>
        <tr><td height="55">星座：</td><td><input type="text" readonly="readonly" value="${requestScope.vo.bConstellation }"/></td><td>最喜欢的人：</td><td><input type="text" readonly="readonly" value="${requestScope.vo.bLovepeople }"/></td></tr>
        <tr><td height="58">最喜欢的食物：</td><td><input type="text" readonly="readonly" value="${requestScope.vo.bLovefood }"/></td><td>最喜欢的一句话：</td><td><input type="text" readonly="readonly" value="${requestScope.vo.bLovesay }"/></td></tr>
        <tr><td height="59">最喜欢的水果：</td><td><input type="text" readonly="readonly" value="${requestScope.vo.bLovefruit }"/></td><td>最喜欢的国家：</td><td><input type="text" readonly="readonly" value="${requestScope.vo.bLovecountry }"/></td></tr>
        <tr><td height="51">最喜欢的老师：</td><td><input type="text" readonly="readonly" value="${requestScope.vo.bLoveteacher }"/></td><td>座右铭：</td><td><input type="text" readonly="readonly" value="${requestScope.vo.bMotto }"/></td></tr>
        <tr><td style="float:left;">给我的留言：</td><td colspan="3"><textarea readonly="readonly"  style="width:440px; height:80px;font-size: 14px;color: gray;/*background-color:#FEEDB7;border:none; color:gray;*/">${requestScope.vo.bLeaveword }</textarea></td></tr>
        <tr><td></td>
        <td><a href="book/book_show1.jsp" style="color: green;">上一张[${sessionScope.UserName }1]</a></td>
        <td><a href="book/book_show1.jsp" style="color: green;">下一张[${sessionScope.UserName }3]</a></td></tr>
    </table>
              </div>
          </div>
        </div>
