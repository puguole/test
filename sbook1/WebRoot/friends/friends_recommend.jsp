...
<div class="header2">
 ...
 <c:forEach items="${requestScope.list }" var="vo">
  <tr>
   <td height="46" style="line-height:5px;">&nbsp;</td>
    <c:choose>
		<c:when test="${vo.uHead !=null}">
			<td style="line-height:6px; color: #50A01A; font-size:13px; font-family:微软雅黑;"><p><a href="#"><img src="${vo.uHead }" width="51" height="46" /></a></p></td>
		</c:when>
		<c:otherwise>
			<td style="line-height:6px; color: #50A01A; font-size:13px; font-family:微软雅黑;"><p><a href="#"><img src="images/photo1.png" width="51" height="46" /></a></p></td>
		</c:otherwise>
	</c:choose>
     <td style="line-height:6px; color: #50A01A; font-size:13px; font-family:微软雅黑;"><p><strong>${vo.uName}</strong></p></td>
     <td style="line-height:6px; color: #50A01A; font-size:13px; font-family:微软雅黑;"><p>${vo.uSex }</p></td>
    <td style="line-height:6px; color: #50A01A; font-size:13px; font-family:微软雅黑;"><p>${vo.uReadingschool }</p></td>
    <td style="line-height:6px; color: #50A01A; font-size:13px; font-family:微软雅黑;"><p>${vo.uReadschool }</p></td>
     <td style="line-height:6px; color: #50A01A; font-size:13px; font-family:微软雅黑;"><p><a href="friend!friends_add?fname=${vo.uName }">加为好友</a></p></td>
