...
<div class="header2">
  ...
  <div class="content">
	...
	<div class="log_top">
        ...
        <p><b>[${sessionScope.UserName }]的日志-好友最新日志</b></p><hr/>
    ...
    <div class="log_botton">
    	<div class="log_menu">
        	<ul>
            	<li style="background-color:white; border-left:1px solid green; border-right:1px solid green; border-top:1px solid green;;"><a href="log!logfriends" style="color:black;">好友的最新日志</a></li>
        ...
        <div class="log_botton_freindslog">
        	<form action="log!logsearch">
            <div style="">&nbsp;搜索好友：&nbsp;<input type="text" name="searchfriend" value="${requestScope.searchInfo }"/>&nbsp;<input type="submit" value="搜索"/></div>
            </form>
        	<!--如果好友没有最新日志动态，就显示下面这个-->
        	<c:if test="${requestScope.list =='[]'}">
        		<div class="log_botton_freindslog_no">
            	<span><b>你的好友没有最新动态，或者你还没有该好友！</b></span><br />
            ...
            <div class="log_botton_freindslog_yes">
            	<table>
                	<tr style="font-size: 14px;text-align: left;"><th>好友</th><th>日志名</th><th>发表日期</th><th>点击查看</th></tr>
                    <tr><td colspan="4"><hr style="color:green; padding:0; margin:0"/></td></tr>
                   <c:forEach items="${requestScope.list }" var="list">
                    <tr style="font-size: 12px; text-align: left;"><td>${list.uName }</td><td><span class="show_text2" style=" margin-left:53px;">${list.lTitle }</span></td><td>${list.lTotime }</td><td><a href="log!logshow?uname=${list.uName }&title=${list.lTitle }" style="color:green;">点击查看</a></td></tr>
                   </c:forEach>
                </table>
            </div>
        	</c:if>
