...
<div class="header2">
  ...
  <div class="content">
	...
	<div class="log_top">
        ...
        <p><b>[${sessionScope.UserName }]的邮件-草稿箱</b></p><hr/>
    ...
    <div class="log_botton">
    	<div class="log_menu">
        	<ul>
                ...
                <li style="background-color:white; border-left:1px solid green; border-right:1px solid green; border-top:1px solid green;"><a href="mail/mail_draft.jsp" style="color:black;">草稿箱</a></li>
        ...
        <div class="log_botton_freindslog">
            ...
            <div class="mail_botton_systeminfor_yes">
                <table>
                    ...
                    <td width="103" style="font-size:14px;">编辑</td>
                    <td width="136" style="font-size:14px;">保存时间</td>
                    ...
                    <td style="color:green;"><a href="mail!mailgowrite" style="color:green;">编辑</a></td><td width="136" style="font-size:10px;">2014-03-22 12:20:11</td><td><a href="#"  style="color:green;">删除</a></td><td width="10"></td></tr>
                   ...
                   <!--下面可以循环读取-->
                    ...
                    <td style="color:green;"><a href="#" style="color:green;">编辑</a></td><td width="136" style="font-size:10px;">2014-03-22 12:20:11</td><td><a href="#"  style="color:green;">删除</a></td><td width="10"></td></tr>
                    <tr><td colspan="7"><hr style=" border:1px dotted #CCCCCC;padding:0px; margin:0px;"/></td></tr>
                    <tr  style="color:gray;"><td ><input type="checkbox" value="0" name="select_one"/>选择</td><td><span class="show_text2">系统终端消息</span></td><td><span class="show_text1">水水水水水水水你好吗哈哈哈</span></td><td><a href="#"  style="color:green;">查看</a></td>
                    <td style="color:green;"><a href="#" style="color:green;">编辑</a></td><td width="136" style="font-size:10px;">2014-03-22 12:20:11</td><td><a href="#"  style="color:green;">删除</a></td><td width="10"></td></tr>
                    <tr><td colspan="7"><hr style=" border:1px dotted #CCCCCC;padding:0px; margin:0px;"/></td></tr>
