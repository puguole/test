...
<body>
	...
	<div class="container">
		...
		<div class="content">
			...
			<form action="mood!moodadd" method="post">
				<div style="border:0px dashed;   margin:0 auto; margin-top:22px;">
					<textarea style="width:740px; height:100px; margin-left:22px;"
						name="content"></textarea>
					<div style="width:750px;">
						<div
							style="font-family:微软雅黑;font-size:15px;margin-left:40px;margin-top:5px;float:left;">
							<img src="images/facelook.png" align="absmiddle" /><a href="">&nbsp;表情&nbsp;&nbsp;</a><img
								src="images/picture.png" align="absmiddle" /><a href="">&nbsp;图片&nbsp;&nbsp;</a><img
								src="images/mind.png" align="absmiddle" /><a href="">&nbsp;心情&nbsp;&nbsp;</a><img
								src="images/ywen.png" align="absmiddle" /><a href="">&nbsp;提到好友&nbsp;&nbsp;</a>
						</div>
						<input type="submit" value=" 发  表 "
							style="float:right;background-color:#5DB819;font-family:微软雅黑;font-size:15px;font-weight:bold;color:white;" />
			</form>


		</div>
		<c:forEach items="${requestScope.list }" var="vo">
			<table border=0px cellspacing="5" width=100%
				style="margin-top: 13px;">
				<tr style="vertical-align:top">
					<td style="width:10%;text-align:center"><img
						src="images/head1.jpg" width="35px" height="35px">
					</td>
					<td>
						<p style="font-size:10px;vertical-align:middle;">
							<a href=""
								style="color:#42B0B0; font-size:17px; font-family:微软雅黑; ">${vo.u_name
								}</a>&nbsp;&nbsp;<span style="vertical-align:middle;"><img
								src="images/zan.png" width="14px" height="14px" />
							</span> 赞数（${vo.m_agreecount }） 发表时间：${vo.m_totime} <a
								href="mood!mooddelete?mid=${vo.m_id }"
								style="color:green;text-decoration: underline;"
								onclick="javascript:return window.confirm('确定要删除吗？')">删除</a>
						</p>
						<p style="border:1px solid #BABABA;font-size:15px;font-family:宋体;">${vo.m_content
							}</p>
					</td>
				</tr>
			</table>
