...
<script type="text/javascript">
	// =============================================================
	// ===== 3D gallery experiment www.5icool.org =====
	// =============================================================
	var m3D = function() {
		/* ---- private vars ---- */
	...
	<script type="text/javascript">
		...
		setTimeout(function() {
			...
			m3D.init([{
				...
				src : 'images/canvas0.jpg'
			}, {
				src : 'images/canvas1.jpg'
			}, {
				src : 'images/canvas2.jpg'
			}, {
				src : 'images/canvas3.jpg'
			}, {
				src : 'images/canvas4.jpg'
			}, {
				src : 'images/canvas5.jpg'
			}, {
				src : 'images/canvas6.jpg'
			}, {
				src : 'images/canvas7.jpg'
			}, {
				src : 'images/canvas8.jpg'
			}, {
				src : 'images/canvas9.jpg'
			}, {
				src : 'images/canvas10.jpg'
			}, {
				src : 'images/canvas11.jpg'
			}, {
				src : 'images/canvas12.jpg'
			}, {
				src : 'images/canvas13.jpg'
			}, {
				src : 'images/canvas14.jpg'
			}, {
				src : 'images/canvas15.jpg'
			}, {
				src : 'images/canvas16.jpg'
			}, {
				src : 'images/canvas17.jpg'
			}, {
				src : 'images/canvas18.jpg'
			}, {
				src : 'images/canvas19.jpg'
			}, {
				src : 'images/canvas20.jpg'
			}, {
				src : 'images/canvas21.jpg'
			}, {
				src : 'images/canvas22.jpg'
			}, {
				src : 'images/canvas23.jpg',
				url : 'http://www.5icool.org/',
				color : '#fff'
			} ]);
		}, 500);
