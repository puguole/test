        ...
        <div class="log_botton_freindslog">
           ...
           -->
            ...
            <div class="photo_mine_yes">
             <span>&nbsp;&nbsp;&nbsp;相册名：<b>${requestScope.p_name}</b>&nbsp;&nbsp; <a href="photo!GouploadServlet?pname=${requestScope.p_name}" style="color: green;">上传新照片</a>&nbsp;&nbsp;<a href="" style="color:green;">删除全部</a> <a href="photo!photogobigphoto?src=${requestScope.list[0].p_path }&uname=${u_name}&pname=${p_name}" style="color:#4D3926;">&nbsp;&nbsp;&nbsp;<img src="images_icon/icon_sign1.png" align="absmiddle" />点击这进入全屏浏览模式</a></span><hr color="#808080"/>
             ...
             <c:forEach items="${requestScope.list}" var="vo">
             	<div class="photo_border_all_border" style=" cursor:pointer;"  onmouseover="show_photo(${vo.p_id }),show_photo2('pp1') " id="pp1" <%-- onmouseout="noshow_photo('p1'),noshow_photo2('pp1')"--%>><!--所有相册都调用的类-->
                	<span><span href="#" style=" color:#4D3926;"><img src="${vo.p_path }" width="160" height="155" style="margin:5px;"/></span></span>
                <span style="margin-left:5px;"><a href="photo!photogobigphoto?src=${vo.p_path }&uname=${u_name}&pname=${p_name}"><span style=" color:#4D3926; width:110px; height:30xp;">查看大图&nbsp;&nbsp;</span></a><a href="photo!PhotoDeleteServlet?p_id=${vo.p_id }" style="color:#4D3926;"><img src="images_icon/icon_delete.png" align="top" style="margin-left:14px;"/>删除</a></span> </div>
                <!--这个是显示大图的div，初始为隐藏-->
