...
<html>
  ...
  <div style="margin: 0 auto;height: 130px;width: 400px;margin-top: 200px;">
  	<table border="0">
  		...
  		<tr><td style="width: 120px;"><a href="login.jsp" style="color: green;">进入登录页面</a></td><td style="width: 120px;"><a href="user!logincheck?uname=${requestScope.uname }&upassword=${requestScope.upassword }" style="color: green;">直接进入首页</a></td></tr>
  	</table>
