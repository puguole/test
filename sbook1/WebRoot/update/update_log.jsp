		...
		<div class="content">
			...
			<div class="log_top">
				...
				<div class="log_top_content">
					<p>
						<b>[${sessionScope.UserName }]的好友动态-日志动态</b>
					</p>
					<hr />
            ...
            <div class="log_botton_freindslog_no">
            	<span><b>你的好友没有最新日志动态，或者你还没有好友！</b></span><br />
                <span style="color:gray; font-size:14px;">记录下生活的点点滴滴，赶快和同学分享你的生活！</span><br />
                <span><a href="log_write.jsp"  style="color:#6CC423; font-size:14px; text-decoration:underline;">自己写日志</a></span>
            </div>
           -->
					<!--如果有的话，就显示下面的内容-->
							...
							<div class="update_mood_content_border" >
								...
								<table>
									<tr>
										...
										<td>&nbsp;&nbsp;<span style=" font-size:17px;color:green;">&nbsp;&nbsp;${vo.uName}
										</span><span style="color:#E6B85C; cursor:pointer;font-size:17px;">赞(0)</span>&nbsp;&nbsp;&nbsp;</td>
									</tr>
									<tr>
										<td>&nbsp;&nbsp;<span style="color:#B3A18F; font-size:14px;">&nbsp;&nbsp;${vo.lTotime }</span>
										</td>
									</tr>
									<tr>
										<td colspan="2"></td>
								...
								<span
									style="height:20px; line-height:20px;overflow:hidden;display:block; margin-left:4px; margin-top:5px; color:#444444;font-family:宋体;font-size:18px;">&nbsp;&nbsp;日志标题：<b style="color:green;">${vo.lTitle}</b>
								</span> 
								<span
									style="width:730px; height:40px; line-height:22px;font-size:14px;overflow:hidden;display:block; margin-left:4px; margin-top:8px; color:#4D3926;padding-left:15px;">${vo.lContent}</span>
								<span style="margin-left:4px;padding-left:15px;"><a
									href="log!logshow?title=${vo.lTitle }&uname=${vo.uName }" style="color:#F1C563;">阅读全部</a>&nbsp;&nbsp; <a
									href="log!logshow?title=${vo.lTitle }&uname=${vo.uName }" style="color:#F1C563;">评论</a> </span>
							</div>
						</div>
					</c:forEach>
				</div>
